...
| IP / Host | Função no Ambiente |
| :--- | :--- |
| **10.10.100.1** | Gateway / Roteador de Borda |
| **10.10.100.2** | Domain Controller (Windows Server / Active Directory) |
| **10.10.100.3** | Host Windows Cliente (RPC) |
| **10.10.100.100** | Servidor Principal (Web, Banco de Dados, Node-RED OT e MQTT) |
| **10.10.100.4 a .8** | Máquinas de Análise / Atacantes (Kali Linux - Equipa CYMAG) |
